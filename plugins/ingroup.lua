...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    ...
    da
ta[tostring(target)]['settings']['lock_arabic'] = 'yes'
    save_data(_config.moderation.data, data)
...
local function enable_strict_rules(msg, data, target)
  ...
  local gro
up_strict_lock = data[tostring(target)]['settings']['strict']
...
function get_message_callback(extra, success, result)
 ...
 elseif get_cmd == 'id' and result.action then
  ...
  local channel = 'channel#id'..resul
t.to.peer_id
...
local function callbackres(extra, success, result)
 ...
 elseif get_cmd == "id" then
  ...
  elseif get_cmd == "invite" then
    ...
    local user_id = "user#id"..result.peer_id
    channe
l_invite(receiver, user_id, ok_cb, false)
...
local function set_supergroup_photo(msg, success, result)
  ...
  local receiver = get_receiver(msg)
  if success then
    local file = 'data/photos/channel_ph
oto_'..msg.to.id..'.jpg'
...
if not is_momod(msg) then
  ...
  --[[ local group_owner = da
ta[tostring(msg.to.id)]['set_owner']
    if group_owner then
     local receiver = get_receiver(msg)
